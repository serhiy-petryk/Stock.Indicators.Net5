...
{
    internal static List<AlligatorResult> CalcAlligator(this List<(DateTime Date, double Value)> tpList,
        int jawPeriods, int jawOffset, int teethPeriods, int teethOffset, int lipsPeriods, int lipsOffset)
    {
