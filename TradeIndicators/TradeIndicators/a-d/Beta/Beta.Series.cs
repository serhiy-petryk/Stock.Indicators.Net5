...
public static partial class Indicator
{
        ...
        BetaType type = BetaType.Standard)
    {
        ...
        List<BetaResult> results = new List<BetaResult>(length);

        bool calcSd = type == BetaType.Standard || type == BetaType.All;
        bool calcUp = type == BetaType.Up || type == BetaType.All;
        bool calcDn = type == BetaType.Down || type == BetaType.All;
        ...
        for (int i = 0; i < length; i++)
        {
            ...
            BetaResult r = new BetaResult(date)
            {
        ...
        BetaType type)
    {
        ...
        // initialize
        CorrResult c = new CorrResult(r.Date);

        List<double> dataA = new List<double>(lookbackPeriods);
        List<double> dataB = new List<double>(lookbackPeriods);
