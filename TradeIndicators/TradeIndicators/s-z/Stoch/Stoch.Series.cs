...
public static partial class Indicator
{
        ...
        MaType movingAverageType)
    {
        ...
        List<StochResult> results = new List<StochResult>(length);
        ...
        for (int i = 0; i < length; i++)
        {
            ...
            StochResult r = new StochResult(q.Date);
            results.Add(r);
        ...
        for (int i = lookbackPeriods - 1; i < length; i++)
        {
            ...
            {
                s = s ?? results[i].Oscillator; // reset if null
        ...
        MaType movingAverageType)
    {
        ...
        else if (movingAverageType is MaType.SMMA)
        {
            ...
            for (int i = lookbackPeriods - 1; i < length; i++)
            {
                k = k ?? results[i].Oscillator; // reset if null
