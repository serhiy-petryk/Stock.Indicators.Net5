...
public static partial class Indicator
{
        ...
        MaType movingAverageType)
    {
        ...
        {
          case MaType.ALMA: return tpList.MaEnvAlma(lookbackPeriods, offsetRatio);
          case MaType.DEMA: return tpList.MaEnvDema(lookbackPeriods, offsetRatio);
          case MaType.EMA: return tpList.MaEnvEma(lookbackPeriods, offsetRatio);
          case MaType.EPMA: return tpList.MaEnvEpma(lookbackPeriods, offsetRatio);
          case MaType.HMA: return tpList.MaEnvHma(lookbackPeriods, offsetRatio);
          case MaType.SMA: return tpList.MaEnvSma(lookbackPeriods, offsetRatio);
          case MaType.SMMA: return tpList.MaEnvSmma(lookbackPeriods, offsetRatio);
          case MaType.TEMA: return tpList.MaEnvTema(lookbackPeriods, offsetRatio);
          case MaType.WMA: return tpList.MaEnvWma(lookbackPeriods, offsetRatio);
          default: throw new ArgumentOutOfRangeException("movingAverageType", movingAverageType, string.Format(EnglishCulture, "Moving Average Envelopes does not support {0}.", Enum.GetName(typeof(MaType), movingAverageType)));
        }
    }
